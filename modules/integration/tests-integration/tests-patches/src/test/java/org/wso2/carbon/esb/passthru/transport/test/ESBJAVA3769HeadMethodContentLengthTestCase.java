...
/**
 * Class for test the content length header of the response in PTT
 */
public class ESBJAVA3769HeadMethodContentLengthTestCase extends ESBIntegrationTest {
	...
	public void setEnvironment() throws Exception {
		...
		String relativePath = "artifacts" + File.separator + "ESB" +
		                      ...
		                      File.separator + "ESBJAVA3769" +
		                      File.separator + "ESBJAVA3769HeadMethodContentLengthTestSynapse.xml";
	...
	@Test(groups = "wso2.esb", description = " Checking Http HEAD method response content length in PTT")
